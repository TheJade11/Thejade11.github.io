    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 col-12-lg all" style="border:3px solid red">
            </div>
        </div>
    </div>
    <div class="container-fluid">
        <div class="row contact">
            ...
            <div class="col-6 col-lg-6">
                <img src="./assets/images/arbre.jpg" width="60%"></img>
            </div>
            <div class="col-6 col-lg-6 mt-5 pe-5 ps-5">
                <p class="mt-1 pt-5"><a href="#">LEE, Jong Hyeok, Ac.</a></p>
                <p>6360 Jean-Talon Est, suite 216
                Montréal, QC, H1S 1M8 (Coin de Langelier)
                </p>
                <p><a href="#">(514) 903-5512</a></p>
                <p><a href="#">(514) 557-1012</a></p>
                </p>
                ...
                <p>info@cliniqueacupuncturelee.com
                 www.cliniqueacupuncturelee.com</p>
                <p></p>
                <p></p>
                <p></p>
                <p></p>
        ...
        <div class="container">
            ...
            <div class="col-12">
                <form action="https://formsubmit.co/tlatoani.moctezuma11@gmail.com" method="POST">
                    <input type="text" name="name" placeholder="Email Adress" required>
